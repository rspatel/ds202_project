...
```{r}
ggplot(rookie_stats) + 
  geom_boxplot(mapping=aes(x=Pos, y=AST_A))
```

```{r}
ggplot(rookie_stats) + 
  geom_boxplot(mapping=aes(x=Pos, y=STL_A))
```

```{r}
ggplot(rookie_stats) + 
  geom_boxplot(mapping=aes(x=Pos, y=BLK_A))
```

```{r}
ggplot(rookie_stats) + 
  geom_boxplot(mapping=aes(x=Pos, y=FT_PRCT))
```

```{r}
ggplot(rookie_stats) + 
  geom_boxplot(mapping=aes(x=Pos, y=FG_A, fill=Pos))
```